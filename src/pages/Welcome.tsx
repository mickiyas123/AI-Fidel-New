  ...
  return (
    <div className="flex gap-5 mt-20 relative h-[calc(100vh-64px)] flex-col w-full items-center">
      ...
      <div className="">
        <img
          src={circleDashed}
          className="absolute md:top-[-10rem] md:right-[-7rem] csl:top-[-9rem] csl:right-[-6rem] cml:top-[-15rem] cml:right-[-10rem] object-contain aspect-square md:w-6/12 w-[400px] right-[-55vw] top-[6rem]"
        />
      </div>
      <div className="absolute md:hidden border-8 z-10 border-white w-[220px] h-[220px] rounded-full top-[-120px] right-[-50px]"></div>
      <div className="absolute md:w-32 w-[340px] aspect-square md:top-32 top-[-100px] md:left-0 csl:left-2 cml:left-[2.4rem] cml:top-[100px] left-[-90px] rounded-full  bg-primary"></div>
