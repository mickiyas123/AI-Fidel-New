...
const UsePC = ({message}) => {
  return (
    <div className="flex gap-10 relative overflow-x-clip h-screen flex-col w-full  items-center">
      ...
      <div className="absolute transition-all border-8 border-white cxs:w-[240px] w-[200px] cxs:h-[240px] h-[200px] rounded-full cxs:top-[-60px] top-[-70px] right-[-70px]"></div>
      <img
        src={circleDashed}
        className="absolute transition-all block object-contain aspect-square cxs:w-[350px] w-[300px] cxs:left-[-120px] left-[-120px] cxs:top-[-50px] top-[-60px]"
      />
